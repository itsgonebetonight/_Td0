...
print("  EXAMPLES (Run these!):")
print("    simple_example.py            ⭐ START HERE - Single SMA backtest")
print("    example_basic.py             Multiple strategies demo")
print("    example_trading.py           Real-time trading simulation")
print("    template_customization.py    Learn customization")
print()

print("  DATA:")
print("    sample_data.csv              93 bars of EUR/USD data")
print("    backtest_results.csv         Sample backtest output")
print()

print("  DOCUMENTATION:")
print("    START_HERE.md                Complete getting started guide")
print("    TESTING_GUIDE.md             How to test the framework")
print("    GETTING_STARTED.md           Installation & setup")
print("    README.md                    Full feature documentation")
print("    PACKAGE_STRUCTURE.md         Architecture details")
print()
...
print()
print("  Python 3.12+")
print("  numpy, pandas, scikit-learn, scipy, matplotlib")
print()
