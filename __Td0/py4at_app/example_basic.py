...
def example_data_loading():
    ...
    print("✓ Data prepared (added 'returns' column)")
    print()
    
    # Add indicators
    print("➕ Adding technical indicators...")
    data_with_sma = DataLoader.add_sma(data_prepared, [10, 20, 50])
    print("✓ Added SMA(10), SMA(20), SMA(50)")
...
if __name__ == '__main__':
    ...
    print("╔" + "=" * 68 + "╗")
    print("║" + " " * 68 + "║")
    print("║" + "  PY4AT_APP - WORKING EXAMPLES  ".center(68) + "║")
    print("║" + "  Test the framework with real backtests  ".center(68) + "║")
    print("║" + " " * 68 + "║")
    print("╚" + "=" * 68 + "╝")
    print()
